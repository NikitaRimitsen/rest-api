...
const widgets = [ //Read 8-12 defineerivad widgets nimelise massiivi, millel on 3 liiget, mis on objektid, millel on 3 atribuuti: id, name ja price
    { id: 1, name: "Nikita", price: 29.99 },
    { id: 2, name: "Jaan", price: 26.99 },
    { id: 3, name: "Rolan", price: 59.99 },
    { id: 4, name: "Artem", price: 28.99 },
    { id: 5, name: "Erik", price: 35.99 },
]
//Read 14-16 defineerivad lõpp-punkti GET /widgets päringule, mis saadab vastusena terve widgets massiivi (mis on defineeritud ridadel 8-12)
app.get('/widgets', (req, res) => {
    res.send(widgets)
})
//Read 18-23 defineerivad lõpp-punkti GET /widgets/id päringule, mis saadab vastusena selle id-ga vastaneva vidina widgets massiivist (defineeritud ridadel 8-12), mis on lisatud /widgets/id asemele. Kui päringul on selline id, mida widgets massiivis ei ole defineeritud, saadetakse tagasi veateade “Widget not found”
...
//Read 40-42 kutsutakse välja meetod listen(). Esimeseks argumendiks on port 8080, millel hakatakse kuulama päringuid. Teiseks (valikuline) argumendiks funktsiooni, kus prinditakse konsoolile aadressi, millel on rakendus kättesaadav
app.listen(8080, () => {
